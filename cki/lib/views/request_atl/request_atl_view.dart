...
class RequestAtlView extends StatefulWidget {
  ...
  const RequestAtlView({super.key, required this.values, required this.description});
...
class _RequestAtlViewState extends State<RequestAtlView> {
  ...
  Widget build(BuildContext context) {
    ...
    mesSheet(RequestAtlViewViewModel model) {
      return Column(
    ...
    return ViewModelBuilder<RequestAtlViewViewModel>.reactive(
        viewModelBuilder: ()=> RequestAtlViewViewModel(price: double.parse(widget.values.toString())),

...
import 'package:cki/views/turmas/turmas_view_model.dart';
...
class ListClassViewView extends StatelessWidget {

  const ListClassViewView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<ListClassViewViewModel>.reactive(
        viewModelBuilder: ()=> ListClassViewViewModel(),

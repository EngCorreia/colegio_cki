...
class AutoFill extends StatefulWidget {
  ...
  @override
  State<AutoFill> createState() => _HomePageState();
}

class _HomePageState extends State<AutoFill> {
  String _code="";
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (_) => const CodeAutoFillTestPage()));
                },

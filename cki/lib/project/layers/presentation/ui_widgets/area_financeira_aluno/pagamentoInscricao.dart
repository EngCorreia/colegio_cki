...
class PramentoInscricao extends StatefulWidget {
  final String idAluno;
  final String studentName;

  const PramentoInscricao({super.key, required this.idAluno, required this.studentName});
  @override
  _PramentoInscricaoState createState() => _PramentoInscricaoState();
}

class _PramentoInscricaoState extends State<PramentoInscricao> {

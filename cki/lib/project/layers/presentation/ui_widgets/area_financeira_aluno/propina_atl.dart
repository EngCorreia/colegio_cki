...
class PropinasAtl extends StatefulWidget {
  final String idAluno;
  final String studentName;

  const PropinasAtl({super.key, required this.idAluno, required this.studentName});
  @override
  _PropinasAtlState createState() => _PropinasAtlState();
}

class _PropinasAtlState extends State<PropinasAtl> {
